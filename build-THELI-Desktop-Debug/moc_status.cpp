...
QT_MOC_LITERAL(3, 22, 12), // "updateStatus"
QT_MOC_LITERAL(4, 35, 20), // "updateStatusReceived"
QT_MOC_LITERAL(5, 56, 12), // "taskBasename"
QT_MOC_LITERAL(6, 69, 7) // "success"

    },
    "Status\0statusChanged\0\0updateStatus\0"
    "updateStatusReceived\0taskBasename\0"
    "success"
};
...
void Status::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->updateStatusReceived((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Status::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Status::statusChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Status::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Status.data,
      qt_meta_data_Status,  qt_static_metacall, nullptr, nullptr}
};
